...
import os
import numpy as np
from fea_extraction import mel_spec
import random
random.seed(233)


data_dir = "/home/ug_yuan/zq/Data/"
class_num = 20
item_num = 20
...
class DataFeed(object):
    def __init__(self):
        ...
        self.cates = "数字 语音 语言 识别 中国 忠告 北京 背景 上海 商行 Speech Speaker Signal Sequence Process Print Project File Open Close".split(
            ' ')
...
class SpecDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, item):
        ...
        return spec.to(device), torch.tensor(clas).to(device)
...
if __name__ == '__main__':
    ...
    dataset = SpecDataset(paths=None, device=device)
    data = dataset[0]
    print(data)
